export default function Testimonials() {
  return (
    <section id="customers" className="py-32 px-6 md:px-24 bg-transparent border-t border-white/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-7xl mx-auto auto-rows-[280px]">
        {/* Row 1 */}
        <div className="col-span-1 border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-center bg-white/[0.03] backdrop-blur-xl hover:bg-white/[0.07] transition-all duration-500 group shadow-2xl">
        ...
        <div className="col-span-2 border border-white/10 rounded-[3rem] p-10 flex flex-col justify-center bg-gradient-to-br from-white/[0.05] to-transparent backdrop-blur-2xl hover:border-violet-500/30 transition-all duration-500 shadow-2xl group">
        ...
        <div className="col-span-1 border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-center items-center text-center bg-white/[0.03] backdrop-blur-xl hover:border-indigo-500/30 transition-all duration-500 shadow-2xl group">
        ...
        {/* Row 2 */}
        <div className="col-span-2 border border-white/10 rounded-[3rem] p-10 flex flex-col justify-center bg-gradient-to-bl from-white/[0.05] to-transparent backdrop-blur-2xl hover:border-fuchsia-500/30 transition-all duration-500 shadow-2xl group">
           <div className="flex items-center gap-8">
        ...
        <div className="col-span-1 border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-between bg-white/[0.03] backdrop-blur-xl hover:bg-white/[0.06] transition-all duration-500 shadow-2xl group">
        ...
        <div className="col-span-1 border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-between bg-white/[0.03] backdrop-blur-xl hover:bg-white/[0.06] transition-all duration-500 shadow-2xl group border-l-4 border-l-fuchsia-600/50">
